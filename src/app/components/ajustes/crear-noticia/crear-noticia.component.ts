...
export class CrearNoticiaComponent implements OnInit {
  ...
  constructor(
    ...
    public tooltipServices: TooltipService) { }
  ...
  ocultarBoton() {
    ...
    this.tooltipServices.settings = false;
    this.tooltipServices.settings2 = false;
  }
  ...
  salirNoticia() {
    ...
    this.tooltipServices.settings = true;
    this.tooltipServices.settings2 = true;
    window.scrollTo(0, 0);
  }
